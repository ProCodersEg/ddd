  ...
  const { data: ads, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from('ads')
        .select('id, type, title, description, image_url, redirect_url, start_date, status, created_at, clicks, impressions, max_clicks, max_impressions, target_audience, frequency_cap')
